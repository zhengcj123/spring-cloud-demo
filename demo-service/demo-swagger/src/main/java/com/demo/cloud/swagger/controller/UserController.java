package com.demo.cloud.swagger.controller;

import com.demo.cloud.swagger.common.ApiResponse;
import com.demo.cloud.swagger.common.DataType;
import com.demo.cloud.swagger.common.ParamType;
import com.demo.cloud.swagger.common.ResponseCode;
import com.demo.cloud.swagger.entity.User;
...
public class UserController {
    ...
    public ApiResponse<User> getByUserName(String username) {
        ...
        return ApiResponse.<User>builder().code(ResponseCode.OK).message("操作成功").data(new User(1, username, "JAVA")).build();
    }
    ...
    public ApiResponse<User> get(@PathVariable Integer id) {
        ...
        return ApiResponse.<User>builder().code(ResponseCode.OK).message("操作成功").data(new User(id, "u1", "p1")).build();
    }
